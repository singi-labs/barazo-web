...
export const mockSearchResults: SearchResult[] = [
  {
    ...
    authorHandle: mockUsers[0]!.handle,
    title: 'Welcome to Barazo Forums',
    content: 'This is the first topic on our new federated forum platform.',
    category: 'general',
    communityDid: COMMUNITY_DID,
  ...
  },
  {
    ...
    authorHandle: mockUsers[1]!.handle,
    title: 'Building with the AT Protocol',
    content: 'A deep dive into building applications on the AT Protocol.',
    category: 'development',
    communityDid: COMMUNITY_DID,
...
export const mockNotifications: Notification[] = [
  {
    ...
    subjectAuthorDid: mockUsers[0]!.did,
    subjectAuthorHandle: mockUsers[0]!.handle,
  ...
  },
  {
    ...
    subjectTitle: null,
    subjectAuthorDid: mockUsers[3]!.did,
    subjectAuthorHandle: mockUsers[3]!.handle,
...
export const mockPages: PageTreeNode[] = [
  {
    id: 'page-about',
    slug: 'about',
    ...
    status: 'published',
    metaDescription: 'Learn about our community forum.',
    parentId: null,
    sortOrder: 0,
    communityDid: COMMUNITY_DID,
    createdAt: TWO_DAYS_AGO,
  ...
  },
  {
    ...
    status: 'published',
    metaDescription: 'How we handle your data.',
    parentId: null,
    sortOrder: 1,
    communityDid: COMMUNITY_DID,
    createdAt: TWO_DAYS_AGO,
  ...
  },
  {
    ...
    status: 'published',
    metaDescription: 'How Barazo uses cookies.',
    parentId: null,
    sortOrder: 3,
    communityDid: COMMUNITY_DID,
    createdAt: TWO_DAYS_AGO,
